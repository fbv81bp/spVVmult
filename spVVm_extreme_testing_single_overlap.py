...
v_rise = create_vec(1000, 100000)
v_fall = create_vec(101000, 200000)

# test : 1 match at the beginning and end of respectove vectors
v_rise.append(100101)
v_fall.append(100101)
